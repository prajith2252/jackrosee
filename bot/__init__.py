...
BOT_TOKEN = environ.get('BOT_TOKEN', '5394714771:AAEpL5JrCGbE5dotz6LRbqwljVVkHtcViX0')
if len(BOT_TOKEN) == 0:
...
if len(GD_INFO) == 0:
    GD_INFO = 'Uploaded by Tma Humter Bot'
